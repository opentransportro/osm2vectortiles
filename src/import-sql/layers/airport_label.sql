CREATE OR REPLACE VIEW airport_label_z9toz14 AS
    SELECT id AS osm_id, geometry, name, name_en, name_es, name_fr, name_de, name_ru, name_zh, name_sv,
    ...
    SELECT id AS osm_id, geometry, name, name_en, name_es, name_fr, name_de,
        name_ru, name_zh, name_sv, iata, ref, icao, faa, aerodrome, type, kind, area
